    ...
    public partial class MainForm : Form
    {
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            using (frmInput)
            {
                ...
                {
                    MessageBox.Show("Error. Please select employee type.");
                    return; // end the method
                }
                

                //add the Employee object to the listbox
        ...
        private void WriteEmpsToFile()
        {
            ...
            //open a pipe to file and create a translator
        ...
        private void DisplayButton_Click(object sender, EventArgs e)
        {
            ...
            {
                //create pipe from the file and create a translator
        ...
        private void EmployeesListBox_DoubleClick(object sender, EventArgs e)
        {
            ...
            //show input/update form with the employee information
            ...
            if (emp is Salary)
            {
                ...
                //mark salaryradiobutton as checked
                frmUpdate.SalaryRadioButton.Checked = true;

                //convert employee reference to a salary object
            ...
            // create employee with updated information
